    ...
    return (
        <Container className="pt-14 pb-16 sm:pt-20">
            <div className="max-w-3xl">
                ...
                <h1 className="mt-3 text-3xl sm:text-5xl font-semibold tracking-tight">Looking for a Solution?</h1>
            ...
            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <a className="rounded-2xl border border-white/10 bg-white/5 p-6 hover:border-white/20 transition" href="https://cal.com/krish-p-hwfjhs" target="_blank" rel="noreferrer">
